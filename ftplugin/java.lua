...
local config = {
  ...
  cmd = {
    ...
    -- 💀
    '-jar', home_jtdls .. '/plugins/org.eclipse.equinox.launcher_1.6.500.v20230717-2134.jar',
    -- ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^                                       ^^^^^^^^^^^^^^
    ...
    -- 💀
    '-configuration', home_jtdls .. '/config_linux',
    -- ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^        ^^^^^^
  ...
  root_dir = require('jdtls.setup').find_root({ '.git', 'pom.xml', 'build.xml' }),
